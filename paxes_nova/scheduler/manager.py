...
scheduler_driver_opts = [
    cfg.StrOpt('scheduler_driver',
               default='paxes_nova.scheduler.filter_scheduler.FilterScheduler',
...
class SchedulerManager(manager.Manager):
    ...
    def image_create(self, context, image_meta, image_data):
        return self.driver.scheduler_image_create(context,
                                                  image_meta,
                                                  image_data)
...
class _SchedulerManagerV3Proxy(object):
    ...
    def image_create(self, context, image_meta, image_data):
        return self.manager.image_create(context,
                                        image_meta,
                                        image_data)
