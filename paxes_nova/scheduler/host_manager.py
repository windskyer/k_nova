...
from paxes_nova.scheduler import weights

host_manager_opts = [
    cfg.MultiStrOpt('scheduler_available_filters',
            default=['paxes_nova.scheduler.filters.all_filters'],
            help='Filter classes available to the scheduler which may '
                    'be specified more than once.  An entry of '
                    '"paxes_nova.scheduler.filters.standard_filters" '
    ...
    cfg.ListOpt('scheduler_weight_classes',
                default=['paxes_nova.scheduler.weights.all_weighers'],
